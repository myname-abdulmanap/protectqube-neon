...
const BRAND_DARK: [number, number, number] = [154, 52, 18];   // orange-800
const BRAND_LIGHT: [number, number, number] = [255, 237, 213]; // orange-100
const BRAND_BG: [number, number, number] = [255, 247, 237];    // orange-50
const TEXT_DARK: [number, number, number] = [67, 20, 7];       // orange-950
const MARGIN = 40;
...
const optimizeLogoDataUrl = async (
  ...
  // Downscale once with high smoothing to reduce file size while keeping edges clear.
