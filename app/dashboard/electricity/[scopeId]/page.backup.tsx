...
const METRIC_GROUPS: {
  ...
  {
    key: "voltageLine",
    label: "Tegangan Antar Fasa",
    lines: [
      { dataKey: "voltageAb", name: "V AB", color: "#2563eb" },
      { dataKey: "voltageBc", name: "V BC", color: "#16a34a" },
      { dataKey: "voltageCa", name: "V CA", color: "#ea580c" },
    ],
  },
  {
    key: "current",
  ...
  },
  {
    ...
    label: "Daya Semu",
    lines: [
      { dataKey: "vaA", name: "VA A", color: "#3b82f6" },
      { dataKey: "vaB", name: "VA B", color: "#10b981" },
      { dataKey: "vaC", name: "VA C", color: "#f59e0b" },
      { dataKey: "vaSigma", name: "VA Sigma", color: "#8b5cf6" },
    ],
  },
  {
    key: "reactive",
    ...
    lines: [
      ...
      { dataKey: "reactiveSigma", name: "Q Sigma", color: "#8b5cf6" },
    ],
  },
  {
    key: "powerQuality",
    label: "Power Factor",
    lines: [
      { dataKey: "pfA", name: "PF A", color: "#3b82f6" },
      { dataKey: "pfB", name: "PF B", color: "#10b981" },
      { dataKey: "pfC", name: "PF C", color: "#f59e0b" },
      { dataKey: "pfSigma", name: "PF Sigma", color: "#8b5cf6" },
    ],
  },
  {
    key: "energy",
...
const mapMetricsToHourlyReadings = (
  ...
  return hourSlots.map((hourIso) => {
    ...
    return {
      ...
      voltageAb: pickValue(values, "voltage_ab"),
      voltageBc: pickValue(values, "voltage_bc"),
      voltageCa: pickValue(values, "voltage_ca"),
      ...
      powerTotal:
        pickValue(values, "power_total") ?? pickValue(values, "power"),
      reactiveL1: pickValue(values, "reactive_l1"),
      reactiveL2: pickValue(values, "reactive_l2"),
      reactiveL3: pickValue(values, "reactive_l3"),
      reactiveSigma: pickValue(values, "reactive_sigma"),
      vaA: pickValue(values, "va_a"),
      vaB: pickValue(values, "va_b"),
      vaC: pickValue(values, "va_c"),
      vaSigma: pickValue(values, "va_sigma"),
      pfA: pickValue(values, "pf_a"),
      pfB: pickValue(values, "pf_b"),
      pfC: pickValue(values, "pf_c"),
      pfSigma: pickValue(values, "pf_sigma"),
      kvarh: pickValue(values, "kvarh"),
...
export default function ElectricityOutletDetailPage() {
  ...
  useEffect(() => {
    ...
    const refreshRealtimePower = async () => {
      ...
      setRealtimePhaseMetrics({
        ...
        voltageAb: Number(getMetricValue("voltage_ab").toFixed(2)),
        voltageBc: Number(getMetricValue("voltage_bc").toFixed(2)),
        voltageCa: Number(getMetricValue("voltage_ca").toFixed(2)),
        ...
        reactiveSigma: Number(getMetricValue("reactive_sigma").toFixed(2)),
        vaA: Number(getMetricValue("va_a").toFixed(2)),
        vaB: Number(getMetricValue("va_b").toFixed(2)),
        vaC: Number(getMetricValue("va_c").toFixed(2)),
        vaSigma: Number(getMetricValue("va_sigma").toFixed(2)),
        pfA: Number(getMetricValue("pf_a").toFixed(4)),
        pfB: Number(getMetricValue("pf_b").toFixed(4)),
        pfC: Number(getMetricValue("pf_c").toFixed(4)),
        pfSigma: Number(getMetricValue("pf_sigma").toFixed(4)),
        kvarh: Number(getMetricValue("kvarh").toFixed(2)),
  ...
  const realtimeSnapshotSections = useMemo(
    () => [
      {
        title: "Voltage",
        cards: [
          { label: "L1", value: realtimePhaseMetrics.voltageL1, unit: "V" },
          { label: "L2", value: realtimePhaseMetrics.voltageL2, unit: "V" },
          { label: "L3", value: realtimePhaseMetrics.voltageL3, unit: "V" },
          { label: "AB", value: realtimePhaseMetrics.voltageAb, unit: "V" },
          { label: "BC", value: realtimePhaseMetrics.voltageBc, unit: "V" },
          { label: "CA", value: realtimePhaseMetrics.voltageCa, unit: "V" },
        ],
      },
      {
        title: "Current",
        cards: [
          { label: "L1", value: realtimePhaseMetrics.currentL1, unit: "A" },
          { label: "L2", value: realtimePhaseMetrics.currentL2, unit: "A" },
          { label: "L3", value: realtimePhaseMetrics.currentL3, unit: "A" },
          {
            label: "Total",
      ...
      },
      {
        title: "Power",
        cards: [
          { label: "L1", value: realtimePhaseMetrics.powerL1, unit: "kW" },
          { label: "L2", value: realtimePhaseMetrics.powerL2, unit: "kW" },
          { label: "L3", value: realtimePhaseMetrics.powerL3, unit: "kW" },
          {
            label: "Total",
      ...
      },
      {
        title: "Reactive",
        cards: [
          { label: "L1", value: realtimePhaseMetrics.reactiveL1, unit: "var" },
          { label: "L2", value: realtimePhaseMetrics.reactiveL2, unit: "var" },
          { label: "L3", value: realtimePhaseMetrics.reactiveL3, unit: "var" },
          {
            label: "Sigma",
            value: realtimePhaseMetrics.reactiveSigma,
            unit: "var",
          },
        ],
      },
      {
        ...
        cards: [
          { label: "A", value: realtimePhaseMetrics.vaA, unit: "VA" },
          { label: "B", value: realtimePhaseMetrics.vaB, unit: "VA" },
          { label: "C", value: realtimePhaseMetrics.vaC, unit: "VA" },
          { label: "Sigma", value: realtimePhaseMetrics.vaSigma, unit: "VA" },
        ],
      },
      {
        title: "Power Factor",
        cards: [
          { label: "A", value: realtimePhaseMetrics.pfA, unit: "PF" },
          { label: "B", value: realtimePhaseMetrics.pfB, unit: "PF" },
          { label: "C", value: realtimePhaseMetrics.pfC, unit: "PF" },
          { label: "Sigma", value: realtimePhaseMetrics.pfSigma, unit: "PF" },
        ],
      },
      {
        title: "Energy",
        cards: [
          { label: "kVArh", value: realtimePhaseMetrics.kvarh, unit: "kVArh" },
          { label: "Freq", value: realtimePhaseMetrics.frequency, unit: "Hz" },
          {
            label: "Total",
            value: realtimePhaseMetrics.energyTotal,
            unit: "kWh",
          },
        ],
      },
  ...
  const handleExportExcel = async () => {
    ...
    const latestEnergyPerDevice = new Map<
      string,
    ...
    for (const device of detail.devices) {
      ...
      locationEnergyMap.set(
        location,
        Number(((locationEnergyMap.get(location) || 0) + energy).toFixed(2)),
      );
    }
    ...
    const exportDevices = (
      richDevices.length > 0 ? richDevices : detail.devices
    ).map((device) => {
        ...
        >
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Data lengkap outlet dan perangkat sesuai periode aktif.
            </p>
          </div>
          <EnergyExportActions
            ...
            <Card className="h-full border shadow-sm">
              <CardContent className="p-2">
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-3">
                  {realtimeSnapshotSections.map((section) => (
                    <div
                      key={section.title}
              ...
              {(() => {
                ...
                > = {
                  all: [
                    ...
                    { key: "voltageAb", label: "V AB" },
                    { key: "voltageBc", label: "V BC" },
                    { key: "voltageCa", label: "V CA" },
                    ...
                    { key: "vaB", label: "VA B" },
                    { key: "vaC", label: "VA C" },
                    { key: "vaSigma", label: "VA Sig" },
                    { key: "reactiveL1", label: "Q L1" },
                    { key: "reactiveL2", label: "Q L2" },
                    { key: "reactiveL3", label: "Q L3" },
                    { key: "reactiveSigma", label: "Q Sig" },
                    { key: "pfA", label: "PF A" },
                    { key: "pfB", label: "PF B" },
                    { key: "pfC", label: "PF C" },
                    { key: "pfSigma", label: "PF Sig" },
          ...
          <Card className="border shadow-sm">
            <CardHeader className="flex flex-row items-center justify-between border-b bg-muted/20">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Setiap perangkat dengan power terakhir dan status.
                </p>
              </div>
