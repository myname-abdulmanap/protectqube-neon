...
export async function GET(
  ...
  try {
    ...
    const backendUrl = `${API_BASE_URL}/device-metrics/${subpathString}${queryString ? `?${queryString}` : ""}`;
    ...
    console.error("Error proxying device-metrics sub-path:", error);
...
export async function POST(
  ...
  try {
    ...
    const backendUrl = `${API_BASE_URL}/device-metrics/${subpathString}`;
