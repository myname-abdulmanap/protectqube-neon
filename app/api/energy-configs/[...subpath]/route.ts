...
export async function GET(
  ...
  try {
    ...
    const backendUrl = `${API_BASE_URL}/energy-configs/${subpathString}${queryString ? `?${queryString}` : ""}`;
    ...
    console.error("Error proxying energy-configs sub-path:", error);
...
export async function POST(
  ...
  try {
    ...
    const backendUrl = `${API_BASE_URL}/energy-configs/${subpathString}`;
