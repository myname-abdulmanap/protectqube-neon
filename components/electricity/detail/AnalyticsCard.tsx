      ...
      <CardContent className="p-0 flex flex-col flex-1 text-sm sm:text-base">
        <div className="grid grid-cols-3 divide-x border-b">
          {[
            {
              label: "Peak Power",
              value: analytics.peakPowerKw,
              unit: "kW",
              ts: analytics.peakPowerAt,
            },
            {
              label: "Total Energy",
              value: analytics.totalEnergyKwh,
              unit: "kWh",
              sub: "Cumulative",
            },
            {
              label: "Reactive",
              value: analytics.totalKvarh,
              unit: "kVARh",
              sub: "Total",
            },
          ].map((item, i) => (
        ...
        <div className="grid grid-cols-2 divide-x divide-y border-b bg-muted/10">
          {[
            ...
            },
            {
              ...
              value: f(analytics.avgPfSigma, 3),
              unit: "",
            },
          ].map((item, i) => (
            <div key={i} className="px-4 py-4 sm:px-5 sm:py-5">
